...
def get_args():
    ...
    optional.add_argument("--assembled", dest='ASSEMBLED',
                          action="store",
                          default=None,
                          type=str,
                          help="pear assembled reads")
...
READ_PREFIX = os.path.split(ASSEMBLED)[-1].split(".fa")[0]
...
# This assertion does not make sense with an assembled input
