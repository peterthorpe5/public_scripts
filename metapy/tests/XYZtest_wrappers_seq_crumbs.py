...
"""Tests of wrapper code in pycits: seq_crumbs"""

import os
import shutil

from pycits import seq_crumbs
...
OUTDIR = os.path.join("tests", "test_out_seq_crumbs")
...
# TARGET OUTPUT DATA
TARGET = os.path.join("tests", "test_targets", "seq_crumbs",
                      "???")
