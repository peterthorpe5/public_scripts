...
def parse_line(line):
    ...
    for entry in cluster_line:
        if entry.startswith("seq"):
            current_read_count = count_reads(entry, current_read_count)
    number_of_reads_hitting_species = current_read_count
