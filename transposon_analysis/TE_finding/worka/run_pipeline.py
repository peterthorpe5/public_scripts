...
clusters of denovo repeat sequences, partialy classified by RepeatMasker """
...
have the translations in a file using the first function in this section.
It is important to remember to use the aliased genome assembly
in the other programs as well, so that redundancies can be resolved.
...
run_repeat_masker('Pi_alt.fasta',
