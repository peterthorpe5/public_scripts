...
i.e Rotifera, filter_out_tax_id or Nematoda), were excluded from the analysis
    ...
    BLAST DATA should be formatted as (standard):
	=============================================
...
======================
``./Lateral_gene_transfer_predictor.py`` -i blast_w_tax_id.tab --tax_filter_out 6656 (e.g.arthropoda) --tax_filter_up_to 33208 (e.g. metazoan) -o PREFIX_out
