#!/bin/bash
#$ -cwd
cd $HOME/scratch/tree_health/reanalysis_THAPBI_2016_MISEQ
...
Working_directory=$HOME/scratch/tree_health/reanalysis_THAPBI_2016_MISEQ
...
#lateralis cactorum gonapodyides agathidicida"
#
#Working_directory=$HOME//scratch/tree_health/rainfall_data
#
##Raw_illumna_data=/mnt/shared/projects/Phytophthora/201711_ITS1_metabarcoding_1_THAPBI/static/RawData/
#
## Nothing to fill in from here!
