...
dos2unix Phytophthora_ITS1_DB_v0.002_20171213.txt
...
download_cmd="python ./bin/generate_database_direct_download.py 
			-t Phytophthora_ITS1_DB_v0.002_20171213.txt 
			-o ./database_file/Phytophthora_FULL_LEN_DB_v0.002_20171213.fasta 
			> ./database_file/Phytophthora_FULL_LEN_DB_v0.002_20171213.WARNING"
echo ${download_cmd}
eval ${download_cmd}
wait
...
HMM_cmd="hmmsearch 
		...
		./bin/Phytophora_ITS1_20171092.hmm 
		./database_file/Phytophthora_FULL_LEN_DB_v0.002_20171213.fasta"
echo ${HMM_cmd}
eval ${HMM_cmd}
wait
...
ITS_cmd="python ./bin/get_DOMAIN_region_I_want_from_fasta_Nucleotide.py 
		-i ./database_file/Phytophthora_FULL_LEN_DB_v0.002_20171213.fasta	
		--hmm ./database_file/ITS1_hmm_domain_table.out 
		-o ./database_file/Phytophthora_ITS1_DB_v0.002_20171213_ITS_only.fasta"
echo ${ITS_cmd}
eval ${ITS_cmd}
wait
...
align_cmd="muscle 
			-in ./database_file/Phytophthora_ITS1_DB_v0.002_20171213_ITS_only.fasta 
			-out ./database_file/Phytophthora_ITS1_DB_v0.002_20171213_ITS_only.fasta.aln "
echo ${align_cmd}
eval ${align_cmd}
wait
...
ITS_cmd="python ./bin/rewrite_as_fasta.py 
		-i ./database_file/Phytophthora_ITS1_DB_v0.002_20171213_ITS_only.fasta	
		-o ./database_file/Phytophora_ITS_database_v0.002.fasta"
echo ${ITS_cmd}
eval ${ITS_cmd}
wait
...
ITS_cmd="python ./bin/Check_protein_seq_for_ILLEGAL_charcter.py 
		-i ./database_file/Phytophora_ITS_database_v0.002.fasta	
...
ITS_cmd="python ./bin/Check_protein_seq_for_ILLEGAL_charcter.py 
		-i temp.fasta	
		-o temp_v0.002.fasta >  ./database_file/Duplicate2.WARNINGS"
echo ${ITS_cmd}
eval ${ITS_cmd}
wait
...
ITS_cmd="python ./bin/rewrite_as_fasta.py 
		-i temp_v0.002.fasta	
		-o Phytophora_ITS_database_v0.002.fasta"
echo ${ITS_cmd}
eval ${ITS_cmd}
wait

rm temp.fasta
rm temp_v0.002.fasta
