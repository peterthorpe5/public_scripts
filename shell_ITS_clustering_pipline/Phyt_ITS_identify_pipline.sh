...
echo "3) puttin the reads together:"
cmd_pear="pear -f ${Name_of_project}_R1.fq.gz 
-r ${Name_of_project}_R2.fq.gz 
...
-f ./${Name_of_project}_outfiles/fastqjoin.join.fasta_with_barcodes 
-l ${left_primer_length} -r ${right_primer_length} --barcode ${barcode_length} 
--ITS CCACAC -o ./${Name_of_project}_outfiles/temp" 
