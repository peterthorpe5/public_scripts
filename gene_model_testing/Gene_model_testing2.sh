...
Working_directory=${Phy_dir}/repeat_masking/Pi_models_RNAseq_Pi_models_BOTH_STRANDS_gff_SW_gene
test_gff="${Phy_dir}/repeat_masking/Pi.models_RNAseq.Pi_models.BOTH_STRANDS.gff"
